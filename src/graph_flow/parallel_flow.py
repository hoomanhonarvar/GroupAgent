...
editor1 = AssistantAgent("editor1", model_client=model, system_message="Edit the paragraph for grammar.")

editor2 = AssistantAgent("editor2", model_client=model, system_message="Edit the paragraph for style.")
